...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    ghadirAuthUserSubject.add(
      GhadirAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<GhadirAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  GhadirAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = GhadirAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    ghadirAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
