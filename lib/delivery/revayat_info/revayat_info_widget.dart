...
import 'revayat_info_model.dart';
export 'revayat_info_model.dart';

class RevayatInfoWidget extends StatefulWidget {
  const RevayatInfoWidget({super.key});

  @override
  State<RevayatInfoWidget> createState() => _RevayatInfoWidgetState();
}

class _RevayatInfoWidgetState extends State<RevayatInfoWidget> {
  late RevayatInfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RevayatInfoModel());
